...
void TextScroller::init(char* text_to_scroll, TextScroller::Direction direction, uint8_t character_spacing, uint8_t y_origin, bool use_small_font) {
  ...
  m_text_number_of_columns = TextUtilities::get_number_of_columns_for_text(m_text_to_scroll, m_character_spacing, m_use_small_font);
